...
<body style="background-color: #add8e6;">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Skill Developer MCC</a>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   ...
                                   <option value="Sistem Informasi" <?php if ($siswa['jurusan'] == 'Sistem Informasi') { ?>
                                        selected='' <?php } ?>>Sistem Infomasi</option>
